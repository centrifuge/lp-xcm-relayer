...
contract XCMRelayerTest is Test {
    ...
    function test_call_centrifuge_process_msg_payload() public {
        ...
        bytes memory expected =
            hex"";

        assertEq(_processMsgPayload(sourceChain, sourceAddress, message), expected);
    }
}
